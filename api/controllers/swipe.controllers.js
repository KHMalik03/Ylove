  ...
  try {
    ...
    if (direction === true) {
      ...
      if (mutualLike.length > 0) {
        ...
        const [matchRows] = await pool.query('SELECT * FROM `match` WHERE match_id = ?', [matchResult.insertId]);
